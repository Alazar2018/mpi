    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {content.kpis.map((kpi, index) => (
          <div key={index} className="bg-[var(--bg-card)] rounded-xl shadow-[var(--shadow-primary)] p-6 transition-colors duration-300">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--text-secondary)]">{kpi.label}</p>
              </div>
            </div>
          </div>
        ))}
                    ...
                    <div>
                      <h2 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                        Weekly Activity
                                             ...
                                             <p className="text-sm text-[var(--text-secondary)]">Track your schedule and upcoming events</p>
                    </div>
                  </div>
                                       {/* Week Summary */}
           <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl border border-blue-100 dark:border-blue-800 transition-colors duration-300">
        ...
        <div className="space-y-4">
          {loadingCalendar ? (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-3 text-gray-600">Loading weekly activity...</span>
            </div>
          ) : (
            <>
          <div className="grid grid-cols-7 gap-2">
                {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day, index) => {
                  ...
                  return (
                       ...
                       <div className="bg-gradient-to-b from-[var(--bg-secondary)] to-[var(--bg-tertiary)] dark:from-slate-700 dark:to-slate-600 rounded-xl p-3 mb-3 shadow-sm border border-[var(--border-primary)] group-hover:border-blue-300 transition-colors">
                         <div 
                       ...
                       <p className="text-sm font-bold text-[var(--text-primary)] group-hover:text-blue-600 transition-colors">{day}</p>
      ...
      <div className="bg-[var(--bg-card)] rounded-xl shadow-[var(--shadow-primary)] p-6 transition-colors duration-300 w-full">
        <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-4">Upcoming Classes</h2>
        {loadingCalendar ? (
          <div className="flex items-center justify-center py-8">
            <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600"></div>
            <span className="ml-3 text-[var(--text-secondary)]">Loading upcoming classes...</span>
          </div>
            ...
            {upcomingClasses.slice(0, 3).map((event) => {
              ...
              return (
                <div key={event.id} className="flex items-center gap-3 p-3 bg-[var(--bg-secondary)] hover:bg-[var(--bg-tertiary)] rounded-lg transition-colors duration-300 border border-[var(--border-secondary)]">
                  ...
                  <div className="text-xs px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 rounded-full capitalize font-medium">
                    {event.type}
                  </div>
                </div>
              );
