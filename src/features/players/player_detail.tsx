...
export default function PlayerDetail() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between gap-4 bg-[var(--bg-card)] rounded-3xl py-6 px-8 shadow-[var(--shadow-secondary)] border border-[var(--border-primary)] transition-colors duration-300">
        ...
        <div className="flex gap-6 bg-[var(--bg-card)] rounded-3xl py-6 px-8 shadow-[var(--shadow-secondary)] border border-[var(--border-primary)] transition-colors duration-300">
  ...
  if (error) {
    return (
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between gap-4 bg-[var(--bg-card)] rounded-3xl py-6 px-8 shadow-[var(--shadow-secondary)] border border-[var(--border-primary)] transition-colors duration-300">
          <span className="text-xl font-semibold text-[var(--text-primary)]">Player Detail</span>
          <Button onClick={clearError} className="!px-6" type="neutral">
            Try Again
          </Button>
        </div>
        <div className="bg-[var(--bg-card)] rounded-3xl py-12 px-8 text-center shadow-[var(--shadow-secondary)] border border-[var(--border-primary)] transition-colors duration-300">
          ...
          <Button onClick={refreshPlayer} className="bg-[var(--bg-primary)] text-[var(--text-primary)] px-8 py-3 rounded-full hover:bg-[var(--bg-secondary)] transition-colors duration-300">
            🔄 Refresh
          </Button>
        </div>
      </div>
    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <div className="bg-[var(--bg-card)] rounded-3xl py-12 px-8 text-center shadow-[var(--shadow-secondary)] border border-[var(--border-primary)] transition-colors duration-300">
          ...
          <p className="text-[var(--text-secondary)] text-lg mb-6">Player not found</p>
          <Button onClick={refreshPlayer} className="bg-[var(--bg-primary)] text-[var(--text-primary)] px-8 py-3 rounded-full hover:bg-[var(--bg-secondary)] transition-colors duration-300">
            🔄 Try Again
          </Button>
        </div>
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Header Section */}
      <div className="flex items-center p justify-between gap-4 bg-[var(--bg-card)] rounded-3xl py-6 px-8 border border-[var(--border-primary)] shadow-[var(--shadow-secondary)] transition-colors duration-300">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[var(--text-primary)]">Player Detail</h1>
          {player && (
              <span className="text-sm text-[var(--text-secondary)]">ID: {player._id}</span>
          )}
          </div>
        </div>
        <div className="flex gap-4">
